...
class Dataformer AppUvicornWorker(UvicornWorker):
...
class Dataformer AppApplication(BaseApplication):
    def __init__(self, app, options=None):
        self.options = options or {}

        self.options["worker_class"] = "dfapp.server.Dataformer AppUvicornWorker"
